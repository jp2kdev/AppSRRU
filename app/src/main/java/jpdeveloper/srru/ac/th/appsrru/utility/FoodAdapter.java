package jpdeveloper.srru.ac.th.appsrru.utility;
...
public class FoodAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView imageTextView = view.findViewById(R.id.imvFood);
        ...
        Picasso.get().load(imageStrings[position]).into((Target) imageTextView);
